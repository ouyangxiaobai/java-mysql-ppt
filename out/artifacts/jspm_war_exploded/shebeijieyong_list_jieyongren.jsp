...
<div style="padding: 10px">
    <%
        ...
        where += " AND jieyongren='" + request.getSession().getAttribute("username") + "' "; //  设置jieyongren为当前登录用户
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei19"
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapshebeifenlei7 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapshebeifenlei7.get("fenleimingcheng") %>
                        </td>
