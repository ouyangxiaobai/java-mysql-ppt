...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "shiyanguanliyuan");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie7" data-value="<%= Info.html(mmm.get("xingbie")) %>" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie" style="width:250px">
