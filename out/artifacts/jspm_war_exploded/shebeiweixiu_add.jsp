...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shebeiweixiu.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <% 
 HashMap mapshebeifenlei22 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='"+readMap.get("fenlei")+"'"); 
 %><%= mapshebeifenlei22.get("fenleimingcheng") %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(readMap.get("fenlei")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <textarea id="weixiuneirong" name="weixiuneirong" style="max-width: 750px;width:100%; height: 300px;"></textarea><script>
            (function(){
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="weixiuren" name="weixiuren" value="<%= request.getSession().getAttribute("username") !=null ? request.getSession().getAttribute("username") : "" %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
