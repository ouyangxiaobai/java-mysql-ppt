            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei11"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_zhuangtai12"
                        ...
                        <script>
                            $(".class_zhuangtai12").val($(".class_zhuangtai12").attr("data-value"))</script>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapshebeifenlei1 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapshebeifenlei1.get("fenleimingcheng") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <%
                                if(map.get("zhuangtai").equals("闲置"))
                                {
                            %>
                            <a href="shebeijieyong_add.jsp?id=<%= map.get("id") %>">设备借用</a>
                           ...
                           %>
                            ...
                            <%
                                if(map.get("zhuangtai").equals("在用"))
                                {
                            %>
                            <a href="shebeiguihuan_add.jsp?id=<%= map.get("id") %>">设备归还</a>
                            ...
                            <% if (Query.make("shebeijieyong").where("shebeixinxiid" , map.get("id")).count() == 0){ %>
