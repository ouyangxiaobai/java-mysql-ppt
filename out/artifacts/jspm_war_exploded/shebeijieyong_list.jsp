...
where+=" AND fenlei ='"+request.getParameter("fenlei")+"'"; } 
                             if(request.getParameter("jieyongshijian_start") != null && !"".equals( request.getParameter("jieyongshijian_start") )){ where+= " AND jieyongshijian >='"+request.getParameter("jieyongshijian_start")+"' "; }      
 if(request.getParameter("jieyongshijian_end") != null && !"".equals( request.getParameter("jieyongshijian_end") )){ where+= " AND jieyongshijian <='"+request.getParameter("jieyongshijian_end")+"' "; }                 if(request.getParameter("jieyongyuanyin") != null && !"".equals( request.getParameter("jieyongyuanyin") )){ where+=" AND jieyongyuanyin LIKE '%"+request.getParameter("jieyongyuanyin")+"%'"; } 
...
<div class="panel panel-default">
    ...
    分类
                            ...
                            <select class="form-control class_fenlei17" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
...
$(".class_fenlei17").val($(".class_fenlei17").attr("data-value"))</script>
    ...
    借用时间
                            ...
                            <input type="text" class="form-control" name="jieyongshijian_start" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'zh-cn'})"/>-<input type="text" class="form-control" name="jieyongshijian_end" readonly="readonly" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',lang:'zh-cn'})"/>                        
</div>
                                                                <div class="form-group">
    借用原因
    
                            <input type="text" class="form-control" style="" name="jieyongyuanyin" value="<%= request.getParameter("jieyongyuanyin") !=null ? request.getParameter("jieyongyuanyin") : "" %>"/>                        
</div>
...
<td> <% 
 HashMap mapshebeifenlei5 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='"+map.get("fenlei")+"'"); 
 %><%= mapshebeifenlei5.get("fenleimingcheng") %> </td>
...
<td> <%= map.get("jieyongren") %> </td>
                        ...
                        <td align="center">
                            ...
                            <a href="shebeijieyong.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('真的要删除？')">删除</a>
                            <!--qiatnalijne-->
                        </td>
                    </tr>
                    <% } %>
