...
<div style="padding: 10px">
    <%
        ...
        where += " AND guihuanren='" + request.getSession().getAttribute("username") + "' "; //  设置guihuanren为当前登录用户
...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
        ...
        if (request.getParameter("guihuanren") != null && !"".equals(request.getParameter("guihuanren"))) {
            where += " AND guihuanren LIKE '%" + request.getParameter("guihuanren") + "%'";
        }
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="guihuanren"
                               value="<%= request.getParameter("guihuanren") !=null ? request.getParameter("guihuanren") : "" %>"/>
                    </div>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapshebeifenlei14 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapshebeifenlei14.get("fenleimingcheng") %>
                        </td>
                        ...
                        <td><%= map.get("guihuanshijian") %>
                        </td>
                        <td><%= map.get("beizhu") %>
                        </td>
                        <td><%= map.get("guihuanren") %>
                        </td>
...
<%--
                            ...
                            <a href="shebeiguihuan.jsp?a=delete&id=<%= map.get("id") %>"
