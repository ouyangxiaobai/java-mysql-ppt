...
<div style="padding: 10px">
    <%
        ...
        where += " AND rukuren='" + request.getSession().getAttribute("username") + "' "; //  设置rukuren为当前登录用户
...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
        ...
        if (request.getParameter("rukushuliang_start") != null && !"".equals(request.getParameter("rukushuliang_start"))) {
            where += " AND rukushuliang >='" + request.getParameter("rukushuliang_start") + "' ";
        }
        if (request.getParameter("rukushuliang_end") != null && !"".equals(request.getParameter("rukushuliang_end"))) {
            where += " AND rukushuliang <='" + request.getParameter("rukushuliang_end") + "' ";
        }
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei35"
                        ...
                        <script>
                            $(".class_fenlei35").val($(".class_fenlei35").attr("data-value"))</script>

                    </div>
                    <div class="form-group">
                        入库数量

                        <input type="text" class="form-control" style="width:80px;" name="rukushuliang_start"
                               value="<%= request.getParameter("rukushuliang_start") !=null ? request.getParameter("rukushuliang_start") : "" %>"/>-
                        <input type="text" class="form-control" style="width:80px;" name="rukushuliang_end"
                               value="<%= request.getParameter("rukushuliang_end") !=null ? request.getParameter("rukushuliang_end") : "" %>"/>
                    </div>
                    <div class="form-group">
                        备注
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapcailiaofenlei37 = new CommDAO().find("SELECT fenleimingcheng FROM cailiaofenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapcailiaofenlei37.get("fenleimingcheng") %>
                        </td>
                        <td><%= map.get("kucun") %>
                        </td>
