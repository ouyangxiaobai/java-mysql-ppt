...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "chuku");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="chuku.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <% 
 HashMap mapcailiaofenlei44 = new CommDAO().find("SELECT fenleimingcheng FROM cailiaofenlei where id='"+mmm.get("fenlei")+"'"); 
 %><%= mapcailiaofenlei44.get("fenleimingcheng") %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(mmm.get("fenlei")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <%= mmm.get("caozuoren") %><input type="hidden" id="caozuoren" name="caozuoren" value="<%= Info.html(mmm.get("caozuoren")) %>"/>                                            
                                                        ...
                                                        <div class="form-group">
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">出库数量<span style="color: red;">*</span></label>
        <div class="col-sm-8">
            
                                                    <input type="number" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写出库数量" number="true" data-msg-number="输入一个有效数字" id="chukushuliang" name="chukushuliang" value="<%= Info.html(mmm.get("chukushuliang")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="chukuren" name="chukuren" value="<%= mmm.get("chukuren") %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
