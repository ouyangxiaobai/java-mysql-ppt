...
<%
    ...
    // 获取当前用户的进行修改
    HashMap mmm = new CommDAO().getmaps("zhanghao"
    , (String)request.getSession().getAttribute("username") , "shiyanguanliyuan");
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shiyanguanliyuan.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" id="zhanghao" name="zhanghao" value="<%= Info.html(mmm.get("zhanghao")) %>"/>                                            
        </div>
    </div>
</div>
                                                                            <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_xingbie6" data-value="<%= Info.html(mmm.get("xingbie")) %>" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie" style="width:250px">
...
$(".class_xingbie6").val($(".class_xingbie6").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写手机号码" id="shoujihaoma" name="shoujihaoma" value="<%= Info.html(mmm.get("shoujihaoma")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写邮箱" email="true" data-msg-email="请输入有效邮件地址" id="youxiang" name="youxiang" value="<%= Info.html(mmm.get("youxiang")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
