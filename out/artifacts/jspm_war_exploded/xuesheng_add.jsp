...
<option value="女">女</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写手机" tel="true" data-msg-phone="请输入正确固定号码" id="shouji" name="shouji" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" id="banji" name="banji" value=""/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
