...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "shebeibaofei");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shebeibaofei.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <% 
 HashMap mapshebeifenlei30 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='"+mmm.get("fenlei")+"'"); 
 %><%= mapshebeifenlei30.get("fenleimingcheng") %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(mmm.get("fenlei")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="chuliren" name="chuliren" value="<%= mmm.get("chuliren") %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
