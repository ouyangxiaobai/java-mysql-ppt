...
<div class="panel panel-default">
    ...
    分类
                            ...
                            <select class="form-control class_fenlei26" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
...
<td> <% 
 HashMap mapshebeifenlei24 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='"+map.get("fenlei")+"'"); 
 %><%= mapshebeifenlei24.get("fenleimingcheng") %> </td>
