...
// 以下是检测搜索框中是否填写了或者选择了什么，则写入sql 语句中
        ...
        if (request.getParameter("chuliren") != null && !"".equals(request.getParameter("chuliren"))) {
            where += " AND chuliren LIKE '%" + request.getParameter("chuliren") + "%'";
        }
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei27"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="" name="chuliren"
                               value="<%= request.getParameter("chuliren") !=null ? request.getParameter("chuliren") : "" %>"/>
                    </div>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapshebeifenlei25 = new CommDAO().find("SELECT fenleimingcheng FROM shebeifenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapshebeifenlei25.get("fenleimingcheng") %>
                        </td>
                        ...
                        <td align="center">
                          ...
                          <%--  <a href="shebeibaofei_updt.jsp?id=<%= map.get("id") %>">修改</a>
                            <a href="shebeibaofei.jsp?a=delete&id=<%= map.get("id") %>"
