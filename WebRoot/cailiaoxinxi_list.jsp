            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei29"
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapcailiaofenlei31 = new CommDAO().find("SELECT fenleimingcheng FROM cailiaofenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapcailiaofenlei31.get("fenleimingcheng") %>
                        </td>
                        ...
                        <td>
                            <%
                                double kucun = Double.valueOf(map.get("kucun").toString()).doubleValue();
                                if (kucun < 10) {
                            %>
                            <span style="color:#de1c1c">
                            <%= map.get("kucun") %>
                            </span>
                            [库存过低]
                            <%} else {%>
                        ...
                        <td align="center">
                            ...
                            <a href="ruku_add.jsp?id=<%= map.get("id") %>">入库添加</a>

                            <a href="chuku_add.jsp?id=<%= map.get("id") %>">出库添加</a>
