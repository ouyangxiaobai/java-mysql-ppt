...
<div style="padding: 10px">
    <%
        ...
        where += " AND chukuren='" + request.getSession().getAttribute("username") + "' "; //  设置chukuren为当前登录用户
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei38"
                        ...
                        <script>
                            $(".class_fenlei38").val($(".class_fenlei38").attr("data-value"))</script>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapcailiaofenlei42 = new CommDAO().find("SELECT fenleimingcheng FROM cailiaofenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapcailiaofenlei42.get("fenleimingcheng") %>
                        </td>
                        <td><%= map.get("kucun") %>
                        </td>
