            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" action="?"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        ...
                        <script>
                            $(".class_fenlei34").val($(".class_fenlei34").attr("data-value"))</script>
            ...
            <div class="">
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tr id="<%= map.get("id") %>" pid="">
                        ...
                        <td><%
                            HashMap mapcailiaofenlei36 = new CommDAO().find("SELECT fenleimingcheng FROM cailiaofenlei where id='" + map.get("fenlei") + "'");
                        %><%= mapcailiaofenlei36.get("fenleimingcheng") %>
                        </td>
                        <td><%= map.get("kucun") %>
                        </td>
                        ...
                        <td align="center">
                            ...
                            <a href="ruku.jsp?a=delete&id=<%= map.get("id") %>"
