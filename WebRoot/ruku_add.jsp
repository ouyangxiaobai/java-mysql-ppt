    ...
    <div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="ruku.jsp?a=insert" method="post" name="form1" id="form1"><!-- form 标签开始 -->
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <%
                                    HashMap mapcailiaofenlei38 = new CommDAO().find("SELECT fenleimingcheng FROM cailiaofenlei where id='" + readMap.get("fenlei") + "'");
                                %><%= mapcailiaofenlei38.get("fenleimingcheng") %><input type="hidden" id="fenlei"
                                                                                         name="fenlei"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">入库数量<span
                                    style="color: red;">*</span></label>
                            <div class="col-sm-8">

                                <input type="number" class="form-control" style="width:150px;" data-rule-required="true"
                                       data-msg-required="请填写入库数量" number="true" data-msg-number="输入一个有效数字"  min="1"
                                       id="rukushuliang" name="rukushuliang" value=""/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
