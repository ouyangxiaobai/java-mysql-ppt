...
$(".class_xingbie3").val($(".class_xingbie3").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写手机" tel="true" data-msg-phone="请输入正确固定号码" id="shouji" name="shouji" value="<%= Info.html(mmm.get("shouji")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        <label style="width: 120px;min-height:18px;text-align: right" class="col-sm-2">班级</label>
        <div class="col-sm-8">
            
                                                    <input type="text" class="form-control" style="width:150px;" id="banji" name="banji" value="<%= Info.html(mmm.get("banji")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" data-rule-required="true" data-msg-required="请填写身份证" idcard="true" data-msg-email="请输入有效身份证号码" id="shenfenzheng" name="shenfenzheng" value="<%= Info.html(mmm.get("shenfenzheng")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
