...
<%
    ...
    HashMap mmm = new CommDAO().getmap(request.getParameter("id") , "shebeixinxi");
    %>
...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="shebeixinxi.jsp?a=update" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="shebeibianhao" name="shebeibianhao" value="<%= Info.html(mmm.get("shebeibianhao")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:250px;" data-rule-required="true" data-msg-required="请填写设备名称" id="shebeimingcheng" name="shebeimingcheng" value="<%= Info.html(mmm.get("shebeimingcheng")) %>"/>                                            
        </div>
    </div>
</div>
                                                        <div class="form-group">
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <select class="form-control class_fenlei16" data-value="<%= Info.html(mmm.get("fenlei")) %>" id="fenlei" name="fenlei" style="width:250px">
<% 
...
<script>
$(".class_fenlei16").val($(".class_fenlei16").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
                                                    ...
                                                    <input type="text" class="form-control" style="width:150px;" readonly="readonly" id="tianjiaren" name="tianjiaren" value="<%= mmm.get("tianjiaren") %>"/>                                            
        </div>
    </div>
</div>
                                <div class="form-group">
